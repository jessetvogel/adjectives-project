...
export function pageHome() {
    return create('div', { class: 'page page-home' }, [
        ...
        create('p', { style: 'text-align: justify' }, 'Welcome to the <i>Adjectives Project</i>! On this website you can search for examples of schemes and morphisms based on combinations of adjectives. Also, you can see which properties automatically follow from your given assumptions.'),
